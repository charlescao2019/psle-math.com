...
&=&%s.
\\\\end{array}
', $distance, $time_quotient, $time_numerator, $time_denumerator, $distance,$time_quotient, $time_numerator, $time_denumerator,$distance,$time_quotient*$time_denumerator+$time_numerator,$time_denumerator,$distance,$time_denumerator,$time_quotient*$time_denumerator+$time_numerator,$speed);
