...
&=&%s.
\\\\end{array}
', $speed, $time_quotient, $time_numerator, $time_denumerator, $speed,$time_quotient, $time_numerator, $time_denumerator,$speed,$time_quotient*$time_denumerator+$time_numerator,$time_denumerator,$distance);
