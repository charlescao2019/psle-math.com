...
// time = alpha*beta;
    ...
    $question = sprintf('%s took $%s\\\\frac{%s}{%s}$ h to travel %s km. What was his/her average speed in km/h?', $name, $time_quotient, $time_numerator, $time_denumerator, $distance, $name);
...
Here Distance=%s km, Time is $%s\\\\frac{%s}{%s}$ h, and therefore the speed is:
\\\\begin{array}{rcl}
%s\\\\div%s\\\\frac{%s}{%s}&=&%s\\\\div\\\\frac{%s}{%s}\\\\\\\\
&=&%s\\\\times\\\\frac{%s}{%s}\\\\\\\\
&=&%s
\\\\end{array}
km/h.', $distance, $time_quotient, $time_numerator, $time_denumerator, $distance,$time_quotient, $time_numerator, $time_denumerator,$distance,$time_quotient*$time_denumerator+$time_numerator,$time_denumerator,$distance,$time_denumerator,$time_quotient*$time_denumerator+$time_numerator,$speed);
