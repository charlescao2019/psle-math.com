...
$multiply_1_array = array_merge(range(0.01,0.99,0.01), range(10,999,1));
$multiply_2_array = array(10,20,30,40,50,60,70,80,90,2,3,4,5,6,7,8,9);
...
{
	$randIndex = array_rand($multiply_1_array, 1);
	$num = $multiply_1_array[$randIndex];

	$randIndex = array_rand($multiply_2_array, 1);
	$den = $multiply_2_array[$randIndex];

    $question = sprintf('What is value of %s$\\\\times$%s?', $num, $den);
